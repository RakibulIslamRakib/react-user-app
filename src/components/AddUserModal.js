            ...
            <div className="relative p-4 items-center">
                ...
                <form onSubmit={handleSubmit(handleData)}>
                  <label className="pl-2">First Name :</label>
                    <input {...register('firstName')}  className='bg-transparent w-3/4 rounded-lg shadow-lg px-2 m-2 border-2 border-gray-100' 
                      placeholder="First Name..." required/><br/>
                  <label className="pl-2">Last Name :</label>
                    <input {...register('lastName')}  className='bg-transparent w-3/4 rounded-lg shadow-lg px-2 m-2 border-2 border-gray-100' 
                      placeholder="Last Name..." required/><br/>
                  <label className="pl-2">E-mail :</label>
                    <input {...register('email')}  className='bg-transparent w-3/4 rounded-lg shadow-lg px-2 m-2 border-2 border-gray-100' 
